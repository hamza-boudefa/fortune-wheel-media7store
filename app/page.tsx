...
export default function HomePage() {
  ...
  const handleUserReady = (id: number) => setUserId(id)
        ...
        <div className="text-center space-y-8 relative z-10">
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-10 border border-white/20 shadow-2xl max-w-2xl mx-auto">
            ...
            <div className="bg-red-50 rounded-xl p-6 mb-6 border border-red-200">
              ...
              <div className="text-3xl font-bold text-red-600 bg-white rounded-lg py-3 px-4">{wonPrize.name}</div>
            </div>
  ...
  if (!userId) return <UserForms onUserReady={handleUserReady} />
